    ...
    <div className="mx-auto max-w-6xl px-6 py-10 md:px-8">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-ember-500 to-ember-400 px-4 py-2.5 text-sm font-semibold text-ink-950"
        >
      ...
      {showForm && (
        <motion.form
          ...
          className="glass mt-6 overflow-hidden rounded-2xl p-6"
        >
          ...
          <textarea
            ...
            {...field('description')}
            className="mt-3 w-full rounded-xl bg-white/5 px-3 py-2.5 text-sm"
            rows={2}
          />
          ...
          <button
            disabled={submitting}
            className="mt-4 rounded-xl bg-white/10 px-5 py-2.5 text-sm font-medium hover:bg-white/15 disabled:opacity-50"
          >
          ...
          <div key={v.id} className="rounded-2xl border border-white/8 bg-ink-800/40 p-4">
            ...
            {(v.status === 'ACTIVE' || v.status === 'INACTIVE') && (
              <button
                ...
                className="mt-3 flex items-center gap-1.5 rounded-lg bg-white/5 px-3 py-1.5 text-xs font-medium hover:bg-white/10"
              >
